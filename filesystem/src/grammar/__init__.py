...
EXTENSION_TO_PARSER = {
    # Python
    '.py': PythonParser, '.pyx': PythonParser, '.pyw': PythonParser,
    # C/C++
    '.c': CCppParser, '.cpp': CCppParser, '.cc': CCppParser, '.cxx': CCppParser, '.h': CCppParser, '.hpp': CCppParser, '.hxx': CCppParser,
    # JavaScript
    '.js': JavaScriptParser, '.jsx': JavaScriptParser, '.mjs': JavaScriptParser,
    # TypeScript
