...
"""
        ...
        properties = [
            e
            for e in elements
            if e.element_type == ElementType.VARIABLE and e.parent == class_element
        ]
        methods = [
            e
            for e in elements
            if e.element_type == ElementType.METHOD and e.parent == class_element
        ]
...
"""
        ...
        namespace = next(
            (e for e in elements if e.element_type == ElementType.NAMESPACE), None
        )
