...
class TypeScriptParser(JavaScriptParser):
    ...
    def _parse_interface_declaration(self, tokens: List[Token], index: int) -> Optional[Dict[str, Any]]:
        """
    ...
    def _parse_type_alias(self, tokens: List[Token], index: int) -> Optional[Dict[str, Any]]:
        """
        ...
        type_alias_node = {
            ...
            "value": {
                "type": "TypeValue",
                "tokens": list(range(start_of_type, index - 1 if tokens[index-1].token_type == TokenType.SEMICOLON else index)),
                "start": start_of_type,
                "end": index - 1,
                "parent": None,
                "children": []
    ...
    def _parse_brace_block(self, tokens: List[Token], index: int) -> Tuple[List[int], int]:
        """
